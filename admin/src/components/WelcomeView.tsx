    ...
    <div style={{ flexBasis: 0, flexGrow: 1, overflowY: "auto" }}>
      <div style={{ maxWidth: 600, margin: "20px auto" }}>
        ...
        <div className={classes!.gridLine}>
          <div className={classes!.gridText}>
            <div className={classes!.paragraph}>
              ClimbLive is targeting small boulder contests, where the
              contenders keep track of their results by themselves.
            </div>
            <div className={classes!.paragraph}>
              Normally this is made with scoreboards on paper, but now you can
              replace or combine it with a web page.
            </div>
          </div>
        ...
        <div className={classes!.gridLine}>
          ...
          <div className={classes!.gridText}>
            <div className={classes!.paragraph}>
              ...
              when contenders reports progress.
            </div>
            <div className={classes!.paragraph}>
              Easier to follow for spectators, and more exciting for the
              contenders.
            </div>
          </div>
        </div>
        <div className={classes!.gridLine}>
          <div className={classes!.gridText}>
            <div className={classes!.paragraph}>
              No calculations required by the contenders, and the results are
              available directly when the contest ends.
            </div>
            <div className={classes!.paragraph}>
              People can even follow contests remotely!
            </div>
          </div>
        ...
        <div className={classes!.gridLine}>
          ...
          <div className={classes!.gridText}>
            <div className={classes!.paragraph}>
              Create your own contests easily in a web frontend.
            </div>
            <div className={classes!.paragraph}>
              Please sign up above to try it out. It's completely free, and we
