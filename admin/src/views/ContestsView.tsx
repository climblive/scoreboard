...
class ContestsView extends React.Component<
              ...
              <TableRow>
                ...
                <TableCell className={"icon-cell"}>
                  <IconButton
                    ...
                    aria-label="Menu"
                    title="Add contest"
                    onClick={() => this.props.history.push("/contests/new")}
                  >
                    <AddIcon />
                  </IconButton>
                </TableCell>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(withRouter(ContestsView)));
