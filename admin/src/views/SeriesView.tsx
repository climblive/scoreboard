  ...
  render() {
    ...
    return (
      ...
      >
              ...
              <TableRow>
                ...
                <TableCell className={"icon-cell"} style={{ minWidth: 96 }}>
                  <IconButton
                    ...
                    aria-label="Menu"
                    title="Add serie"
                    onClick={this.props.startAddSeries}
                  >
                    <AddIcon />
                  </IconButton>
                </TableCell>
        ...
        <ConfirmationDialog
          open={this.state.deleteSeries != undefined}
          title={"Delete series"}
...
function mapDispatchToProps(dispatch: Dispatch<any>) {
  return {
    ...
    deleteSeries: (series: Series) =>
      dispatch(asyncActions.deleteSeries(series)),
    updateEditSeries: (propName: string, value: any) =>
      dispatch(actions.updateEditSeries({ propName: propName, value: value })),
  };
}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(withRouter(SeriesView)));
