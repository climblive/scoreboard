...
class OrganizersView extends React.Component<
  ...
  render() {
    ...
    return (
      ...
      >
              ...
              <TableRow>
                ...
                <TableCell className={"icon-cell"} style={{ minWidth: 96 }}>
                  <IconButton
                    ...
                    aria-label="Menu"
                    title="Add serie"
                    onClick={this.props.startAddOrganizer}
                  >
                    <AddIcon />
                  </IconButton>
                </TableCell>
                    ...
                    <TableRow key={organizer.id}>
                      ...
                      <TableCell className={"icon-cell"}>
                        <IconButton
                          ...
                          title="Edit"
                          onClick={() =>
                            this.props.startEditOrganizer!(organizer)
                          }
                        >
                          <EditIcon />
                        </IconButton>
        ...
        <ConfirmationDialog
          open={this.state.deleteOrganizer != undefined}
...
function mapDispatchToProps(dispatch: Dispatch<any>) {
  return {
    ...
    startEditOrganizer: (organizer: Organizer) =>
      dispatch(actions.startEditOrganizer(organizer)),
    ...
    deleteOrganizer: (organizer: Organizer) =>
      dispatch(asyncActions.deleteOrganizer(organizer)),
    updateEditOrganizer: (propName: string, value: any) =>
      dispatch(
        actions.updateEditOrganizer({ propName: propName, value: value })
      ),
  };
}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(withRouter(OrganizersView)));
