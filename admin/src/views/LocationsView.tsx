  ...
  render() {
    ...
    return (
      ...
      >
              ...
              <TableRow>
                ...
                <TableCell className={"icon-cell"} style={{ minWidth: 96 }}>
                  <IconButton
                    ...
                    aria-label="Menu"
                    title="Add location"
                    onClick={this.props.startAddLocation}
                  >
                    <AddIcon />
                  </IconButton>
                </TableCell>
        ...
        <ConfirmationDialog
          open={this.state.deleteLocation != undefined}
          title={"Delete location"}
...
function mapDispatchToProps(dispatch: Dispatch<any>) {
  return {
    ...
    startEditLocation: (location: CompLocation) =>
      dispatch(actions.startEditLocation(location)),
    ...
    deleteLocation: (location: CompLocation) =>
      dispatch(asyncActions.deleteLocation(location)),
    updateEditLocation: (propName: string, value: any) =>
      dispatch(
        actions.updateEditLocation({ propName: propName, value: value })
      ),
  };
}
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(withRouter(LocationsView)));
