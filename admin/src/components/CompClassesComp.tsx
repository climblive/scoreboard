  ...
  render() {
    ...
    return (
      <Paper style={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
            ...
            <TableRow>
              ...
              <TableCell className={"icon-cell"} style={{ minWidth: 96 }}>
                <IconButton
                  ...
                  aria-label="Menu"
                  title="Add class"
                  onClick={this.props.startAddCompClass}
                >
                  <AddIcon />
                </IconButton>
              </TableCell>
              ...
              if (
                ...
                return (
                  <TableRow key={compClass.id}>
                    ...
                    <TableCell>
                      {moment(compClass.timeBegin).format(this.format)}
                    </TableCell>
                    <TableCell>
                      {moment(compClass.timeEnd).format(this.format)}
                    </TableCell>
                    <TableCell className={"icon-cell"}>
                      <IconButton
                        ...
                        title="Edit"
                        onClick={() =>
                          this.props.startEditCompClass!(compClass)
                        }
                      >
                        <EditIcon />
                      </IconButton>
                ...
                return (
                  <TableRow key={compClass.id} style={{ cursor: "pointer" }}>
                    ...
                    <TableCell>
                      <TextField
                        style={{}}
                        value={editCompClass.description}
                    ...
                    <TableCell>
                      <DateTimePicker
                        ...
                        format={this.format}
                        value={timeBegin}
                        onChange={this.onTimeBeginChange}
                      />
                    </TableCell>
                    <TableCell>
                      <DateTimePicker
        ...
        {compClasses != undefined && compClasses.length == 0 && (
          <div className={"emptyText"}>
            <div>You have no contest classes.</div>
            <div>
              Please create at least one contest class by clicking the plus
              button above.
            </div>
          </div>
        )}
        <ConfirmationDialog
          open={this.state.deleteCompClass != undefined}
          title={"Delete class"}
